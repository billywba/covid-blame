                    ...
                    if hasattr(comment_row_tuple, "author_city"):
                        ...
                        cursor.execute(insert_comment_query, 
                                        (
                                            ...
                                            article_id, 
                                            comment_row_tuple.author_city if comment_row_tuple.author_city else "", 
                                            comment_row_tuple.author_country if comment_row_tuple.author_country else "", 
